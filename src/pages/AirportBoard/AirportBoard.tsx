...
const AirportBoardComponent = ({ icao }: AirportBoardProps) => {
  ...
  return (
    <div style={{ padding: '0.01rem' }}>
              ...
              if (item) {
                ...
                return (
                  <tr key={`${item.p.callsign}-arr`}>
                    ...
                    <td>
                      <BoardBlock text={callsignSplit} length={TICKER_WIDTHS.callsign} />
                    </td>
                    <td>
              ...
              if (item) {
                ...
                return (
                  <tr key={`${item.p.callsign}-dep`}>
                    ...
                    <td>
                      <BoardBlock text={destLabel} length={TICKER_WIDTHS.name} />
                    </td>
                    <td>
                      <BoardBlock text={displayState} length={TICKER_WIDTHS.state} />
                    </td>
      ...
      <div style={{ marginTop: '1.5rem', paddingTop: '0.5rem', borderTop: '1px solid #eee', display: 'flex', gap: '1rem', alignItems: 'center', flexWrap: 'wrap' }}>
        ...
        <div style={{ marginLeft: 'auto', textAlign: 'right', color: '#999', fontSize: '0.9rem' }}>
